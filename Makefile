...
SOURCE_FILES := main.c uart.c adc.c sram.c joystick.c touch.c oled.c
...
TARGET_DEVICE := m162
F_CPU := 4915200 # Modify if changing device!!

CC := avr-gcc
CFLAGS := -O -std=c11 -DF_CPU=$(F_CPU) -mmcu=$(TARGET_CPU) -u vfprintf -lprintf_flt
